...
namespace ReplaceGuid
{
    ...
    public class TestByMultipleFormat
    {
        ...
        [TestCase(50)]
        [TestCase(100)]
        public void TestGuidByRandomValidFormatWithNewGuid(int count)
        {
            TestGuidByRandomValidFormat(count, Guid.NewGuid);
        }
        ...
        [TestCase(50)]
        [TestCase(100)]
        public void TestGuidByRandomValidFormatWithSequencialGuid(int count)
        {
            // GUID generator for source data
            var srcGuidGenerator = new GuidGenerater();
            TestGuidByRandomValidFormat(count, srcGuidGenerator.NewGuid);
        }
        ...
        [TestCase(50)]
        [TestCase(100)]
        public void TestGuidByRandomInvalidFormatWithNewGuid(int count)
        {
            TestGuidByRandomInvalidFormat(count, Guid.NewGuid);
        }
        ...
        [TestCase(50)]
        [TestCase(100)]
        public void TestGuidByRandomInvalidFormatWithSequencialGuid(int count)
        {
            // GUID generator for source data
            var srcGuidGenerator = new GuidGenerater();
            TestGuidByRandomInvalidFormat(count, srcGuidGenerator.NewGuid);
        }
        ...
        public void TestGuidByRandomValidFormat(int count, ReplaceWithNewGuid.NewGuid newSrcGuid)
        {
        ...
        /// <param name="count">loop count</param>
        /// <param name="newSrcGuid">delegate for creating new source GUIDs</param>
        public void TestGuidByRandomInvalidFormat(int count, ReplaceWithNewGuid.NewGuid newSrcGuid)
        {
            var builderInput = new StringBuilder();
